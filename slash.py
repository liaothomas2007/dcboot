...
class Slash(commands.Cog):
    ...
    @app_commands.command(name = "create", description = "創造角色")
    @app_commands.describe(name = "名稱", age = "年齡")
    async def create(self, interaction: discord.Interaction, name: str, age: Optional[str] = None):
        await interaction.response.send_message(f"建立角色{nl}名稱:{name}{nl}年齡:{age}")
